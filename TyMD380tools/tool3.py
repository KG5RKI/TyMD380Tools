...
# 2016-12-30, DL4YHF : Added a few new functions ( grep for the callsign )
#   and renamed this modified 'descendant' from md380_tool.py to tool2.py .
